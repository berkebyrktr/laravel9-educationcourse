	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Create Category</h1>
				    </div>
				    <div class="col-auto">
				...
				<form class="auth-form login-form" role="form" action="/admin/category/update/{{$data->id}}" method="post"> 
					@csrf  
					...
					<div class="keywords mb-3">
						...
						<input id="keywords" name="keywords" value="{{$data->keywords}}" type="text" class="form-control keywords" placeholder="Keywords" required="required">
					</div><!--//form-group-->
