	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
				    <div class="app-auth-branding mb-4"><a class="app-logo" href="/admin"><img class="logo-icon me-2" src="{{asset('/')}}admin_panel/assets/images/app-logo.svg" alt="logo"></a></div>
					...
					<div class="auth-form-container text-left">
						...
						<div class="auth-option text-center pt-5"><a class="app-link" href="/admin/login" >Log in</a> <span class="px-2">|</span> <a class="app-link" href="/admin/login" >Sign up</a></div>
