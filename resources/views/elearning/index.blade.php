    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{asset('/')}}elearning/about.html" class="nav-item nav-link">About</a>
                <a href="{{asset('/')}}elearning/courses.html" class="nav-item nav-link">Courses</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="{{asset('/')}}elearning/team.html" class="dropdown-item">Our Team</a>
                        <a href="{{asset('/')}}elearning/testimonial.html" class="dropdown-item">Testimonial</a>
                        <a href="{{asset('/')}}elearning/404.html" class="dropdown-item">404 Page</a>
                    </div>
                </div>
                <a href="{{asset('/')}}elearning/contact.html" class="nav-item nav-link">Contact</a>
            </div>
