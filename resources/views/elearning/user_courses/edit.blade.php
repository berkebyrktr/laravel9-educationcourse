...
<body>
                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">{{$item->title}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        ...
        <form class="auth-form login-form" role="form" action="/user_courses/update/{{$data->id}}" method="post"> 
					@csrf  
					...
					<div class="title mb-3">
						...
						<input id="title" name="title" value="{{$data->title}}" type="text" class="form-control title" placeholder="Title" required="required">
					</div><!--//form-group-->
					<div class="description mb-3">
						<label class="sr-only" for="description">Description</label>
						<input id="description" name="description" value="{{$data->description}}" type="text" class="form-control description" placeholder="Description" required="required">
					</div><!--//form-group-->
					<div class="video mb-3">
						<label class="sr-only" for="video">Video</label>
						<input id="video" name="video" value="{{$data->video}}" type="text" class="form-control video" placeholder="Video" required="required">
					</div><!--//form-group-->
					<div class="time mb-3">
						<label class="sr-only" for="time">Time</label>
						<input id="time" name="time" value="{{$data->time}}" type="text" class="form-control time" placeholder="Time" required="required">
					</div><!--//form-group-->
					<div class="price mb-3">
						<label class="sr-only" for="price">Price</label>
						<input id="price" name="price" value="{{$data->price}}" type="text" class="form-control price" placeholder="Price" required="required">
					</div><!--//form-group-->
